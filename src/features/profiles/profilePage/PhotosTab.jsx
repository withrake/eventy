    ...
    <Tab.Pane loading={loading}>
      <Grid>
        <Grid.Column width={16}>
          ...
          {isCurrentUser && (
            <Button
              onClick={() => setEditMode(!editMode)} //always sets the button to the opposite of editMode
              floated='right'
              basic
                ...
                <Card key={photo.id}>
                  ...
                  <Button.Group fluid widths={2}>
                    <Button
                      ...
                      onClick={(e) => handleSetMainPhoto(photo, e.target.name)} //e = event, we target the individual button and provide an individual loading indicator for each button
                      disabled={photo.url === profile.photoURL} //this button is disabled, if it is the profile picture
                      basic
                      color='green'
                      content='Main'
                    />
